import 'package:schat_server/model/user.dart';
import 'package:schat_server/schat_server.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:schat_server/schat_server.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for schat_server.
///
...
///         }
///
class Harness extends TestHarness<SchatServerChannel> with TestHarnessAuthMixin<SchatServerChannel>, TestHarnessORMMixin {
  @override
